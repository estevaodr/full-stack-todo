 ...
 * All routes are prefixed with 'server-feature-todo' and will be accessible
 * at /api/server-feature-todo (the /api prefix is set globally in main.ts)
 */
...
export class ServerFeatureTodoController {
  ...
  /**
   * GET /api/server-feature-todo/:id
  ...
  /**
   * PUT /api/server-feature-todo/:id
  ...
  /**
   * PATCH /api/server-feature-todo/:id
  ...
  /**
   * DELETE /api/server-feature-todo/:id
