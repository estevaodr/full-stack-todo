...
function AutoIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18V4c4.41 0 8 3.59 8 8s-3.59 8-8 8z" fill="currentColor" />
    </svg>
  );
}
...
export function ThemeSelector() {
  ...
  return (
    <button
      ...
      aria-label={`Current: ${LABELS[current]}. Click to switch.`}
      title={LABELS[current]}
      className="p-2 rounded-lg bg-card border border-border shadow-sm hover:bg-muted transition-colors text-foreground"
    >
      <Icon />
    </button>
  );
