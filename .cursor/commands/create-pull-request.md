---
description: Create a pull request for code changes. Analyzes git diff or GitHub PR diff summary to generate a comprehensive PR description with proper formatting.
---
...
Create a pull request for the given code changes. Capable of interpreting both git diff output and GitHub's PR diff summary. Provides thorough explanations, insights, reasoning for changes, and enumerates potential bugs.
...
Provide the git diff or GitHub PR diff summary when invoking this command.